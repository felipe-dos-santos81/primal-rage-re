...
demo window `[843..3616]` (raw `3750..8409`), **2774 frames: 0 clean / 0 splice
/ 0 transition / 2768 unexplained** (6 all-black frames excluded); the first
unexplained frame is capture **843 (raw 3750)** — the T-rex's animation pose,
not the state-9 hold. (Cycle 1's Amendment 5 said the fight begins at 839/28;
