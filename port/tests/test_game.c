...
int test_frontend(void)
{
     ...
     * front-end window is distinct [560..858] (299 frames: 134 clean, 161
     ...
     * 851..857, and [560..857]/298 before the 0x2A690 mode-1 x fix
     * explained 858). The [557..810]/254 text here was
